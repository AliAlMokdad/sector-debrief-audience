...
(async function () {
  ...
  function renderAll() {
    ...
    $('#t-summary').innerHTML = `<div class="kpi hero"><p class="l">Total listeners and viewers</p><p class="v">${n(all)}</p></div>` + kp('pv', 'YouTube views', n(vt), vPeriod) + kp('pa', 'Podcast plays and downloads', n(at), aPeriod) + (Wb ? kp('pw', 'Google Search impressions', n(wt), wPeriod) : '');
